...
ATOM_EXPANDO(_NET_WM_WINDOW_TYPE_MENU)  	// menus close when focused
ATOM_EXPANDO(_NET_WM_WINDOW_TYPE_COMBO) 	// xfrun4 freaks out when focused
ATOM_EXPANDO(_NET_WM_WINDOW_TYPE_NORMAL)	// can be cycled with alt+tab
ATOM_EXPANDO(_NET_WM_WINDOW_TYPE_DIALOG)	// no special treatment yet
